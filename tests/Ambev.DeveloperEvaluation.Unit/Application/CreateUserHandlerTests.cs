...
public class CreateUserHandlerTests
{
    ...
    public CreateUserHandlerTests()
    {
        ...
        _handler = new CreateUserHandler(_userRepository, _mapper, _passwordHasher, _eventPublisher, correlationId,
    ...
    /// <summary>
    /// Tests that an empty command fails validation via the command validator.
    /// Validation runs in the MediatR pipeline — this test exercises the validator directly.
    /// </summary>
    [Fact(DisplayName = "Given invalid user data When validated Then returns validation errors")]
    public void Given_InvalidUserData_When_Validated_Then_ReturnsErrors()
    {
        // Given
        var command = new CreateUserCommand(); // all empty
